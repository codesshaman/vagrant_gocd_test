# Vagrant virual machine with gocd
...
Clonr this repository: git clone https://github.com/codesshaman/vagrant_gocd_test.git

### Step 3

Copy box and go inside the repository folder:

``cp ~/Downloads/a22d1053-8311-450b-a740-6e3017c087f8 path_to/vagrant_gocd_test/debian``

``cd vagrant_gocd_test``
